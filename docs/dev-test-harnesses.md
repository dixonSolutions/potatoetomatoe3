...
| `pnpm bridge-test`                          | headless Chromium   | In-game bridge end to end: virtual storage (isolation, save, relaunch, fresh origin, postMessage pull), typed IndexedDB, live key detection, Controls menu (purposes, search, grouping), dynamic console buttons, shortcut / typing classification, single dispatch per press, Move mode |
