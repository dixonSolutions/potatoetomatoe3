...
import { outDirForGame } from '../shrek/config.js';
import { discoverGameInfo } from '../shrek/discover.js';
import { downloadAssets, downloadUrlList } from '../shrek/download.js';
import { writeHostFiles } from '../shrek/host.js';
import { mergeSplitFiles } from '../shrek/merge.js';
import { buildAssetRouteMap, scanGameDirectory } from '../shrek/scan-assets.js';
